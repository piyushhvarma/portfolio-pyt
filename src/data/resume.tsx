...
export const DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Contributed to open source projects during Hacktoberfest 2025, focusing on UI polish, theming, and frontend performance.\n- Merged 13+ pull requests across 6 repositories in a single month.\n- Built persistent dark mode systems, smooth-scroll utilities, and glassmorphism UI components.\n- Improved accessibility and reduced API response time using parallel fetch strategies.",
    ...
    },
    {
      ...
      description:
        "Open source contributor during GirlScript Summer of Code 2025, working across 8+ repositories on UI and frontend tooling.\n- Delivered 9 pull requests covering analytics features, layout fixes, and dark mode consistency.\n- Built a data export feature (CSV/JSON) and habit streak tracking for a React productivity app.\n- Improved WCAG compliance and responsive design across platforms with broad user reach.",
