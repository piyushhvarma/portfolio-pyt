...
export const DATA = {
  ...
  avatarUrl: "/me.png",
  skills: [
    { name: "React", icon: ReactLight, iconSrc: "/icons/React Logo.png" },
    { name: "Next.js", icon: NextjsIconDark },
    { name: "Vue.js", icon: Code2, iconSrc: "/icons/vuejs.webp" },
    { name: "Typescript", icon: Typescript, iconSrc: "/icons/typescript.webp" },
    { name: "JavaScript", icon: Code2, iconSrc: "/icons/javascript.png" },
    { name: "Node.js", icon: Nodejs },
    { name: "Python", icon: Python },
    { name: "C++", icon: Csharp, iconSrc: "/icons/c++.png" },
    { name: "MongoDB", icon: Postgresql, iconSrc: "/icons/mongo-db.png" },
    { name: "Postgres", icon: Postgresql },
    { name: "Docker", icon: Docker },
    { name: "Kubernetes", icon: Kubernetes },
    { name: "Git", icon: GitBranch, iconSrc: "/icons/git.png" },
    { name: "GitHub", icon: Icons.github, iconSrc: "/icons/github.webp" },
    { name: "CSS", icon: FileCode2, iconSrc: "/icons/css.png" },
    { name: "Tailwind CSS", icon: Tailwind, iconSrc: "/icons/tailwind.webp" },
    { name: "Gen AI", icon: Sparkles },
    { name: "Machine Learning", icon: BrainCircuit },
    { name: "Computer Vision", icon: Eye },
    { name: "WordPress", icon: LayoutTemplate, iconSrc: "/icons/wordpress.webp" },
