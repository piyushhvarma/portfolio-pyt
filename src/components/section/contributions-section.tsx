                                ...
                                <div className="flex items-center justify-between w-full pr-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col items-start gap-0.5">
                                            ...
                                            <span className="font-sans text-sm text-orange-500/80">{gssocProjects.length} Repositories Merged</span>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between w-full pr-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col items-start gap-0.5">
                                            ...
                                            <span className="font-sans text-sm text-purple-500/80">{hacktoberProjects.length} Repositories Merged</span>
                                        </div>
                                    </div>
                                    <ChevronDown className="h-5 w-5 text-muted-foreground transition-transform duration-500 ease-in-out group-data-[state=open]:rotate-180" />
                                </div>
